export variant_mutable_struct, fitness_location_type
...
mutable struct spatial_result_type
  ...
  num_trials::Int64
  N_list::Vector{Int64}   # meta-population size
  num_subpops_list::Vector{Int64}   # number of subpopulations
  num_emigrants_list::Vector{Int64}       # num emigrants
  num_attributes_list::Vector{Int64}  # number of attributes of a variant
  mu_list::Vector{Float64}     # innovation rate
  ...
  linear_variation_list::Vector{Bool}    # Whether to vary ideal values in a circular fashion
...
mutable struct spatial_run_result_type
  ...
  num_emigrants::Int64       # num emigrants
